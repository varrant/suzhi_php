...
function fcode($src_path, $type_path, $position, $salary, $fringe ){
	...
	imagefttext($dst, 12, 0, 16, 30, $black, $font, '物流拣货员');
	imagefttext($dst, 12, 0, 16, 85, $black, $font, '薪资待遇');
	imagefttext($dst, 12, 0, 280, 85, $golden, $font, '100元 / 天');
	imagefttext($dst, 12, 0, 16, 135, $black, $font, '福利待遇');
	imagefttext($dst, 12, 0, 160, 135, $golden, $font, '五险一金，双休，美女如云...');
	...
	imagecopyresampled($dst, $src, 108, 310, 0, 0, 139, 139, 296, 296); 
	...
	switch ($dst_type) {
	    ...
	    case 2://JPG
	        ...
	        imagejpeg($dst,'Public/codeer/re'.time().'jpg' );
	...
	return 'Public/codeer/re'.time().'jpg';
