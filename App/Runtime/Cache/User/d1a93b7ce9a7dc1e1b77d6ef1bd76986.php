					...
					<?php if(is_array($res)): foreach($res as $key=>$v): ?><li><a href="<?php echo U('task/details',array('pos_id'=>$v['pos_id']));?>">
						...
						<div class="list_word">
							<h3>
								...
								<?php }?>
								<?php echo ($v['pos_name']); ?><span class="price"><?php echo ($v['pos_salary']); ?></span></h3>
							<p></p>
							<div class="list_num">
			...
			success: function(data){
				if(data.data.length > 0){
					...
					$.each(data.data,function(index,item){
						...
						ghtml +="<li><a href=\"/index.php/user/task/details?pos_id="+item['pos_id']+"\"><div class='list_img'><img src="+item['pos_img']+" width='100%' /></div><div class='list_word'><h3>"+shtml+""+item['pos_name']+"<span class='price'>"+item['pos_salary']+"</span></h3><p></p><div class='list_num'><span>需求："+item['pos_recruitmun']+"人</span><div class='list_view'><span><img src='/Public/home/images/taskico1.png' />"+item['total_toudi']+"</span><span><img src='/Public/home/images/taskico2.png' />"+item['total_liulan']+"</span></div></div></div></a></li>";
