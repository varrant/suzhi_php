...
<html class="no-js">
    ...
    <body>
        <div id="app">
            ...
            <!-- 填写手机号步骤 -->
            <form method="post" action="<?php echo U('regcmt');?>" onsubmit="return regcheck();">
                <div class="liststep1" style="display: block;">
                    ...
                    <div class="btn_box">
                        <button class="btn_login_out" id="btn_login" >下一步</button>
                    </div>
                    <br/>
                    <div class="btn_box">
                        <button class="btn_login_over" onclick="javascript:window.open('<?php echo U('User/Login/index');?>)'" type="button">已注册，去登录</button>
                    </div>
                </div>
            </form>
            <!-- 上传身份证步骤 -->
    ...
    <script>
        ...
        var register = new Vue({
                    el: '#app',
                    data: {
                        registerUrl: '<?php echo U("User/Register/smsvcode");?>',
