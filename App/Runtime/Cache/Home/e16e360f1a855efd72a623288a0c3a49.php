    ...
    <body>
        ...
        <div class="menu_list">
            <div class="ipt_box2">
                ...
                <div class="right">
                    <div class="ipt_value">
                        <input type="text" class="inp_username" placeholder="" readonly ="readonly" value="<?php echo ($user["he_name"]); ?>">
                        &nbsp;
            ...
            <div class="ipt_box2">
                ...
                <div class="right">
                    <div class="ipt_value">
                        <input type="text" class="inp_username" placeholder="" readonly ="readonly"  value="<?php echo ($user["he_sex"]); ?>">
                        &nbsp;
                        <i class="fa fa-angle-right" aria-hidden="true"></i>
                    </div>
                </div>
            ...
            <div class="ipt_box2">
                ...
                <div class="right">
                    <div class="ipt_value">
                        <input type="text" class="inp_username" placeholder="" readonly ="readonly"  value="<?php echo ($user["he_major"]); ?>">
                        &nbsp;
                        <i class="fa fa-angle-right" aria-hidden="true"></i>
                    </div>
                </div>
            ...
            <div class="ipt_box2">
                ...
                <div class="right">
                    <div class="ipt_value">
                        <input type="text" class="inp_username" placeholder="" readonly ="readonly"  value="<?php echo ($user["he_education"]); ?>">
                        &nbsp;
                        <i class="fa fa-angle-right" aria-hidden="true"></i>
                    </div>
                </div>
            ...
            <div class="ipt_box2">
                ...
                <div class="right">
                    <div class="ipt_value">
                        <input type="text" class="inp_username" placeholder="" readonly ="readonly"  value="<?php echo ($user["he_shcool"]); ?>">
                        &nbsp;
                        <i class="fa fa-angle-right" aria-hidden="true"></i>
                    </div>
                </div>
            ...
            <div class="ipt_box2" style="border-bottom: 0px solid #d8d8d8;">
                ...
                <div class="right">
                    <div class="ipt_value">
                        <input type="text" class="inp_username" placeholder="" readonly ="readonly"  value="<?php echo ($user["he_grade"]); ?>">
                        &nbsp;
                        <i class="fa fa-angle-right" aria-hidden="true"></i>
                    </div>
                </div>
