...
<div id="app">
    ...
    <div class="liststep3" style="display: none;">
        ...
        <div class="ipt_box2">
            ...
            <div class="right">
                <div class="ipt_value">
                    <input type="text" id="he_occupation" v-model="registerModel.he_occupation" class="inp_username" placeholder="请选择">
                    <i class="fa fa-angle-right" aria-hidden="true"></i>
                </div>
            </div>
            <div class="clearbox"></div>
...
<script>
    ...
    var register = new Vue({
        el: '#app',
        data: {
            registerUrl: 'http://www.test.com/index.php/home/Register/smsvcode',
            registerUrl1: 'http://www.test.com/index.php/home/Register/regstep1',
            registerUrl2: 'http://www.test.com/index.php/home/Register/regstep2',
            registerUrl3: 'http://www.test.com/index.php/home/Register/regstep3',
            registerModel: {
                phone: '',
                code: '',
                he_carid: '',
