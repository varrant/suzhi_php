...
<body style="">
	...
	<!--二维码-->
	<div class="code_view">
		<div class="code_img"><img src="/qrcode.php?url=http://test.91suzhi.com/index.php/user/register/index?id=<?php echo ($data['he_id']); ?>" width="148px" height="152px" /><p>长按识别 一起速职</p></div>
	</div>
</body>
</html>