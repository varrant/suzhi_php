  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">全职类型添加</strong> / <small></small></div>
      </div>
      ...
      <div class="am-g">
        ...
        <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
          <form class="am-form am-form-horizontal" id="from_job" action="<?php echo U('Optiment/doqzlist');?>" method="post">
            ...
            <div class="am-form-group">
              <div class="am-u-sm-9 am-u-sm-push-3">
                <button type="button" id="but_job"  class="am-btn am-btn-primary">添加全职类型</button>
              </div>
            </div>
          </form>
        </div>
...
<script type="text/javascript">
  $('#but_job').click(function (e) { 
      ...
      var t_url ="<?php echo U('Optiment/qzlist',array('id'=>2));?>";
      var dot =1;
      if($('#PosName').val()==""){
            dot=0;
            alert('先写名称');
