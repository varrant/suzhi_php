        ...
        <div class="am-u-sm-12 am-u-md-6">
          <div class="am-btn-toolbar">
            <div class="am-btn-group am-btn-group-xs">
              <a href="<?php echo U('Optiment/addsxlist',array('id'=>0));?>"><button type="button"; class="am-btn am-btn-default"><span class="am-icon-plus"></span>添加</button></a>
            </div>
          </div>
        </div>
      </div>
          ...
          <form class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main">
              ...
              <?php if(is_array($data)): foreach($data as $key=>$v): ?><tr>
                ...
                <td><?php echo ($v['pos_sort']); ?></td>
                <td>
                <?php if($v['poshot'] == '0' ): ?>是 <?php else: ?>否<?php endif; ?>
                </td>
                <td>
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                      <button type="submit" formmethod="get" formaction="<?php echo U('Optiment/eidsxlist',array(id=>$v['pos_id']));?>" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span>修改</button>
                      <button id="del<?php echo ($v['id']); ?>" type="button" formaction1="<?php echo U('Optiment/sxlist');?>" formmethod="get" formaction="<?php echo U('Optiment/delzwlx',array(id=>$v['pos_id']));?>" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</button>
                    </div>
                  </div>
                </td>
