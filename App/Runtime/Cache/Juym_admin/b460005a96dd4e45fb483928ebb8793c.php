    ...
    <div class="admin-content-body">
      ...
      <div class="am-g">
        ...
        <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
          <form class="am-form am-form-horizontal" id="from_job" action="<?php echo U('Optiment/dotjlist');?>" method="post">
            <div class="am-form-group">
              <label for="user-name" class="am-u-sm-3 am-form-label">名称</label>
              <div class="am-u-sm-9">
                <input type="text" id="PosName" name="PosName" placeholder="输入名称" required/>
                <small></small>
              </div>
            </div>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input type="text" name="Possort" id="Possort" placeholder="请输入排序" required/>
                <input type="hidden" name="Posjoptype" id="Posjoptype" value="0">
                <small></small>
              </div>
            </div>
             <div class="am-form-group">
            ...
            <div class="am-form-group">
              <div class="am-u-sm-9 am-u-sm-push-3">
                <button type="button" id="but_job"  class="am-btn am-btn-primary">添加兼职类型</button>
              </div>
            </div>
          </form>
        </div>
...
<script type="text/javascript">
  $('#but_job').click(function (e) { 
      ...
      var t_url ="<?php echo U('Optiment/tjlist',array('id'=>0));?>";
      var dot =1;
      if($('#PosName').val()==""){
            dot=0;
            alert('先写名称');
