            ...
            <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
                <div class="am-form am-form-horizontal" >
                    ...
                    <div class="am-form-group" >
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" value ="" id="he_phone" placeholder="请输入手机号" style="width:52%"/>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" value ="" id="he_nickname" placeholder="请输入昵称" style="width:52%"/>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" value ="" id="he_name" placeholder="请输入姓名" style="width:52%"/>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" value ="" id="he_carid"  placeholder="请输入身份证号" style="width:52%"/>
                    ...
                    <div class="am-form-group">
                        <div id="upimgs">
                            ...
                            <div class="am-u-sm-9">
                                ...
                                <img src="" id="work_images" style="width: 130px;height: 130px;margin-top: 15px;">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" value ="" id="he_birthday" placeholder="请输入生日" style="width:52%"/>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" value ="" id="he_occupation" placeholder="请输入职业" style="width:52%"/>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" value ="" id="he_education" placeholder="请输入学历" style="width:52%"/>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" value ="" id="he_shcool" placeholder="请输入毕业学校" style="width:52%"/>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" value ="" id="he_major" placeholder="请输入专业" style="width:52%"/>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" value ="" id="he_grade" placeholder="请输入入学年份" style="width:52%"/>

                        </div>
                    </div>
                    <div class="am-form-group">
                        <div class="am-u-sm-9 am-u-sm-push-3">
                            <button type="button" onclick="baocun()" class="am-btn am-btn-primary">添加</button>
...
<script type="text/javascript" src="/Public/myjs/my.js"></script>
    ...
    <script type="text/javascript">
        ...
        function baocun(){
            ...
            var data={'he_image':he_image,'he_phone':he_phone,'he_nickname':he_nickname,'he_name':he_name,'he_sex':he_sex,'he_carid':he_carid,'he_idimg':he_idimg,'he_birthday':he_birthday,'he_occupation':he_occupation,'he_education':he_education,'he_shcool':he_shcool,'he_major':he_major,'he_grade':he_grade};

            $.ajax({
                url:"<?php echo U('head/doadds');?>",
                data:data,
                type:'post',
                dataType:"json",
