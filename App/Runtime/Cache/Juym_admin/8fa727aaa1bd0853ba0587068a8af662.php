                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            ...
                            <select id="pos_joptype" class="" name="posjoptype" style="width:52%">
                                ...
                                <?php
 $posdb=M('pos'); $map['pos_joptype']=1; $map['pos_is_delete']=1; $posdata=$posdb->where($map)->select(); foreach($posdata as $k=>$ma){ if($v['pos_joptype'] == $ma['pos_id']){ echo "<option value=".$ma['pos_id']." selected='selected'>".$ma['pos_name']."</option>"; }else{ echo "<option value=".$ma['pos_id'].">".$ma['pos_name']."</option>"; } } ?>
                            </select>
                        </div>
                    </div>
...
<script type="text/javascript" src="/Public/myjs/my.js"></script>
    ...
    <script type="text/javascript">
        ...
        function baocun(){
            ...
            $.ajax({
                url:"<?php echo U('poscha/doview_q');?>",
                data:data,
                type:'post',
                dataType:"json",
                success:function(data){
