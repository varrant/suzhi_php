        ...
        <div class="am-form-group">
          <div id="upimg">
            ...
            <div class="am-form-group" >
              ...
              <div class="am-u-sm-9">
                <input type="text" id="pos_name" placeholder="请输入任务名称" style="width:52%"/>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input type="number" id="pos_recruitmun" placeholder="请输入需求人数" style="width:52%"/>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                ...
                <select id="pos_county" class="" name="posjoptype" style="width:52%">
                          ...
                          <?php
 $posdb=M('pos'); $map['pos_joptype']=3; $map['pos_is_delete']=1; $posdata=$posdb->where($map)->select(); foreach($posdata as $k=>$ma){ echo "<option value=".$ma['pos_id'].">".$ma['pos_name']."</option>"; } ?>
                </select>
              </div>
            </div>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                ...
                <select id="pos_joptype" class="" name="posjoptype" style="width:52%">
                          ...
                          <?php
 $posdb=M('pos'); $map['pos_joptype']=0; $map['pos_is_delete']=1; $posdata=$posdb->where($map)->select(); foreach($posdata as $k=>$ma){ echo "<option value=".$ma['pos_id'].">".$ma['pos_name']."</option>"; } ?>
                </select>
              </div>
            </div>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input type="text" id="pos_worktime" placeholder="请输入工作时间段" style="width:52%"/>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input type="text" id="pos_hours" placeholder="请输入上班时间段"  style="width:52%"/>
              ...
              <div class="am-form-group">
                  ...
                  <div class="am-u-sm-9">
                      <input type="text" id="pos_company_name" placeholder="请输入公司名称"  style="width:52%"/>
              ...
              <div class="am-form-group">
                  ...
                  <div class="am-u-sm-9">
                      <input type="text" id="pos_company_address" placeholder="请输入详细地址"  style="width:52%"/>
              ...
              <div class="am-form-group">
                  ...
                  <div class="am-u-sm-9">
                      <input type="text" id="pos_true_liulan"   value="0" readonly="readonly" style="width:52%"/>
              ...
              <div class="am-form-group">
                  ...
                  <div class="am-u-sm-9">
                      <input type="text" id="pos_true_toudi"   value="0"  readonly="readonly" style="width:52%"/>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input type="text" id="pos_liuan" placeholder="请输入浏览次数"  value="" style="width:52%"/>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                <input type="text" id="pos_toudi" placeholder="请输入投递简历次数"  value="" style="width:52%"/>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                  <textarea id="pos_jobdescription" class="form-control" rows="3"></textarea>
              </div>
            </div>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                  <textarea id="pos_responsibilities" class="form-control" rows="3"></textarea>
              </div>
            </div>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9">
                  <textarea id="pos_welfarebenefits" class="form-control" rows="2"></textarea>
