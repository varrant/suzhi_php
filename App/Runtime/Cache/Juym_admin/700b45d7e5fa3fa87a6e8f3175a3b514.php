            ...
            <div class="am-u-sm-12 am-u-md-6">
                <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                        <a href="<?php echo U('Poscha/adds_q');?>"><button type="button"; class="am-btn am-btn-default"><span class="am-icon-plus"></span>添加</button></a>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript" src="/Public/myjs/my.js"></script>
    ...
    <script type="text/javascript">
        function ssss(dom) {
            ...
            $.ajax({
                url:"<?php echo U('poscha/delete_q');?>",
                data:data,
                type:'post',
                dataType:"json",
