   ...
   // 管理员列表
      function Citylist(){
      	...
      	$db=M('admin');
           ...
           $data=$db->alias('a')->join('think_city b ON a.city=b.id')->field('a.id,a.pid,a.username,a.logintime,a.email,a.zhifubao,a.iPhone,a.sta,a.name,b.name as pname')->where($map)->limit($Page->firstRow.','.$Page->listRows)->select();
