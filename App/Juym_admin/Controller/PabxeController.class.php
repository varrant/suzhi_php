...
class PabxeController extends CommonController {
   ...
   // 管理员列表
      function Pabxlist(){
      	...
      	$db=M('admin');
           ...
           $data=$db->alias('a')->field('a.id,a.pid,a.username,a.logintime,a.email,a.zhifubao,a.iPhone,a.sta,a.name')->where($map)->limit($Page->firstRow.','.$Page->listRows)->select();
